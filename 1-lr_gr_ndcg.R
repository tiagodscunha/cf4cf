setwd("/home/tiago-inesc/Dropbox/doutoramento/source_code/meta_level/CF4CF_conference/")
source("auxiliary.R")

run_experiment_lr <- function(type, iterations){
  
  metafeatures <- read.csv("/home/tiago-inesc/Dropbox/doutoramento/source_code/meta_level/embeddings/metafeatures_graph/graph_metafeatures_final.csv",sep=",")
  
  targets_filename <- ""
  if(type == "IR"){
    targets_filename <- "/home/tiago-inesc/Dropbox/doutoramento/source_code/meta_level/embeddings/targets/IR.csv"
  }
  else {
    targets_filename <- "/home/tiago-inesc/Dropbox/doutoramento/source_code/meta_level/embeddings/targets/RP.csv"
  }
...
setwd("/home/tiago-inesc/Dropbox/doutoramento/source_code/meta_level/CF4CF_empirical/")

save(IR,RP,file="meta_lr_gr_ndcg.Rda")

#all methods will be included in the results
